...
function showNumbersAll() {
    ...
    function render() {
        ...
        autoTimers.push(setTimeout(() => playMP3('en', n), 300));
        autoTimers.push(setTimeout(() => playMP3('ur', n), 1500));
        autoTimers.push(setTimeout(() => playMP3('ar', n), 2700));
    }

    function playMP3(lang, n) {
        return new Promise(resolve => {
            const audio = new Audio('audio/numbers/' + lang + '_' + n + '.mp3');
